  ...
  private initializeSampleData() {
    const sampleUsers: Omit<User, 'id'>[] = [
      ...
      },
      {
        ...
        skills: ["HTML", "CSS"],
        profileImage: "https://images.unsplash.com/photo-1511367461989-f85a21fda167?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        isOnline: true,
        openToCollaborate: false,
        lastSeen: new Date(Date.now() - 24 * 60 * 60 * 1000), // 1 day ago
      },
      // Incomplete user: missing bio, profileImage, and skills
      {
        username: "incomplete_user1",
      ...
      // Incomplete user: missing title and email
      {
        username: "incomplete_user2",
        email: "",
        password: "password123",
        firstName: "Incomplete",
        lastName: "UserTwo",
        ...
        isOnline: false,
        openToCollaborate: false,
        lastSeen: new Date(Date.now() - 72 * 60 * 60 * 1000), // 3 days ago
      },
      // Incomplete user: only username and email
      {
        username: "incomplete_user3",
        ...
        isOnline: false,
        openToCollaborate: false,
        lastSeen: new Date(Date.now() - 96 * 60 * 60 * 1000), // 4 days ago
      },
    ];
