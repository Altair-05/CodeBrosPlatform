    ...
    const sampleUsers: InsertUser[] = [
      {
        ...
        profileImage:
          'https://images.unsplash.com/photo-1536625979259-edbae645c7c3?q=80&w=688&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      ...
      },
      {
        ...
        profileImage:
          'https://images.unsplash.com/photo-1592188657297-c6473609e988?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        openToCollaborate: true,
      },
      {
        username: 'Visishta',
      ...
      const messages: InsertMessage[] = [
        {
          ...
          receiverId: new ObjectId(createdUsers[1]._id),
          content:
            'Hey! I saw your profile and loved your work with Python and Django. Would you be interested in collaborating on a project?',
        },
        {
          senderId: new ObjectId(createdUsers[1]._id),
          receiverId: new ObjectId(createdUsers[0]._id),
          content:
            "Absolutely! I'd love to work together. What kind of project do you have in mind?",
        },
        {
          senderId: new ObjectId(createdUsers[0]._id),
          receiverId: new ObjectId(createdUsers[1]._id),
          content:
            "I'm thinking of building a developer networking platform. It would be perfect for our skills!",
        },
        {
          senderId: new ObjectId(createdUsers[1]._id),
          receiverId: new ObjectId(createdUsers[0]._id),
          content:
            'That sounds amazing! I can handle the backend with Django and you can work on the React frontend. When can we start?',
        },
        {
          senderId: new ObjectId(createdUsers[0]._id),
          receiverId: new ObjectId(createdUsers[3]._id),
          content:
            "Hi Komal! I'm impressed by your DevOps expertise. Would you be interested in helping us set up CI/CD for our project?",
        },
        {
          senderId: new ObjectId(createdUsers[3]._id),
          receiverId: new ObjectId(createdUsers[0]._id),
          content:
            "Of course! I'd be happy to help with the CI/CD setup. What tech stack are you planning to use?",
        },
      ];
